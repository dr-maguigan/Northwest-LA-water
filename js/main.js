...
//wallace lake
var wl_elev = 161.51
var wl_depth = (20.3 -3.2).toFixed(2);
var wl_wt = (wl_elev - wl_depth).toFixed(2);

//blanchard
var b_elev = 226.75
var b_depth = (6.1 - 3.46).toFixed(2);
var b_wt = (b_elev - b_depth).toFixed(2);

//greenwood
var gw_elev = 264.15
var gw_depth = (48.5 - 3.61).toFixed(2);
var gw_wt = (gw_elev - gw_depth).toFixed(2);

//eddie jones park
var ejp_elev = 247.99
var ejp_depth = (13.8 - 3.31).toFixed(2);
